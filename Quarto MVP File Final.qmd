...
The dataset satisfies the FAIR principles because it is findable, stored in the csv file in the project repository. It is accessible. It is interoperable as the csv can be read by multiple programs. It is also reusable reusable.
